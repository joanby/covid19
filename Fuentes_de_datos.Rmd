...
modelo_datos=bind_rows(lapply(tipos,FUN=arreglo))

```

## Añadiendo Metadatos a nuestro modelo de datos
...
poblacion_CCAA= poblacion_CCAA %>% 
  filter(`Comunidades y Ciudades Autónomas`!="Total",Periodo==2019) %>%
  transmute(
    cod_ine=str_sub(`Comunidades y Ciudades Autónomas`,1,2),
    Pob_CCAA_2019=Total)
